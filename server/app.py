...
app.json_encoder = None  # Ensure compact=False works
app.json_dumps = lambda obj: jsonify(obj).data  # Add this line to handle custom JSON formatting
